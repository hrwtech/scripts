...
if [ "$state" = "" ]; then
  ...
  echo "Launch cmus in iTerm | zsh='$0' param1=launch-iterm terminal=false refresh=true"
  echo "Launch cmus in Terminal | zsh='$0' param1=launch-terminal terminal=false refresh=true"
  exit
fi
...
if [ "$state" = "playing" ]; then
  echo "Pause | zsh='$0' param1=playpause terminal=false refresh=true"
  echo "Previous | zsh='$0' param1=previous terminal=false refresh=true"
  echo "Next | zsh='$0' param1=next terminal=false refresh=true"
else
  echo "Play | zsh='$0' param1=playpause terminal=false refresh=true"
fi
